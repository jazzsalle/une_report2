...
| ADR-33 | CC-200 상황·후보 SituationFact 수집 — 동기 Provider 경로와 정규화 | ACCEPTED | [ADR-33-cc200-situation-fact-ingestion.md](ADR-33-cc200-situation-fact-ingestion.md) | 중복군·충돌·Snapshot 확정(CC-210), freshness/TTL(WP-SITUATION-09), 실 KMA/MOIS 어댑터·G11 게이트, T3Q 상황 API(OB-02), SafeKorea/Naver 승인(OB-05), provider_result 보존 TTL(**ADR-35에서 종결**) |
