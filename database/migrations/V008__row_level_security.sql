...
CREATE POLICY p_role_tenant ON role USING (tenant_id = une_current_tenant_id()) WITH CHECK (tenant_id = une_current_tenant_id());
...
CREATE POLICY p_provider_config_tenant ON provider_config USING (tenant_id = une_current_tenant_id()) WITH CHECK (tenant_id = une_current_tenant_id());
...
CREATE POLICY p_retention_policy_tenant ON retention_policy USING (tenant_id = une_current_tenant_id()) WITH CHECK (tenant_id = une_current_tenant_id());
